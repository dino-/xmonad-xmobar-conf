...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
    ...
    -- launch dmenu
    , ((modMask,               xK_p     ), spawn "exe=`dmenu_run | dmenu` && eval \"exec $exe\"")
    ...
    --
    -- Note: change below from W.greedyView to W.view
    --   to not have the greedy screen swap with multi screens
